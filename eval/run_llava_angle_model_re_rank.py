...
from video_retrieval_models.text_models.doc_level_angle_embeddings_re_rank import DocLevelAngleEmbeddingsReRank

device = "cuda"
# Best so far:
text_model = DocLevelAngleEmbeddingsReRank(device, pool="mean") 
...
preds_path = Path("/home/ubuntu/csc2508/MSR-VTT/doc_level_angle_preds_re_rank.json") 
